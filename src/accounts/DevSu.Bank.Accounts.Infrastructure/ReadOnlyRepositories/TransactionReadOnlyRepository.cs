...
{
    public class TransactionReadOnlyRepository(ReadOnlyContext readOnlyContext)
        : BaseReadOnlyRepository<long, Transaction>(readOnlyContext), ITransactionReadOnlyRepository
    {
    }
}
